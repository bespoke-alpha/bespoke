...
export default function (_module) {
	...
	const SortBySubMenu = () => {
		...
		return S.React.createElement(
			...
			{ leadingIcon: leadingIcon, displayText: "Sort by", depth: 1, placement: "right-start", disabled: false },
			SubMenuItems.map(SubMenuItem => S.React.createElement(SubMenuItem, { descending: descending })),
		);
	};
	...
	registrar.register(
		"topbarLeftButton",
		S.React.createElement(Button, { label: "Reorder Playlist from Sorted Queue", icon: SVGIcons.shuffle, onClick: reordedPlaylistLikeSortedQueue }),
	);
}
