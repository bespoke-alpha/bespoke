...
const MenuItem = (props) => {
    ...
    return (S.React.createElement(S.ReactComponents.MenuItem, { trigger: "click", onClick: () => switchCallback(option), "data-checked": isActive, trailingIcon: isActive ? S.React.createElement(CheckIcon, null) : undefined, style: isActive ? activeStyle : undefined }, option.name));
};
