...
internalRegisterTransform({
    transform: emit => str => {
        ...
        str = str.replace(/(\(0,([\w_$]+)\.jsx\)\([\w_$]+\.[\w_$]+,\{value:"contextmenu"[^\}]*\}\)\}\))/, `$2.jsx((globalThis.__MenuContext||(globalThis.__MenuContext=${react}.createContext(null))).Provider,{value:{props:${menu}?.props,trigger:${trigger},target:${target}},children:$1})`);
        emit();
        return str;
    },
    glob: /^\/xpui\.js/,
