...
__decorate([property()], AnimatedText.prototype, "split", void 0);
AnimatedText = __decorate([customElement(AnimatedText.NAME)], AnimatedText);
export { AnimatedText };
...
DetailTimelineProvider = __decorate([customElement(DetailTimelineProvider.NAME)], DetailTimelineProvider);
...
TimelineProvider = __decorate([customElement(TimelineProvider.NAME)], TimelineProvider);
export { TimelineProvider };
let LyricsContainer = class LyricsContainer extends SyncedContainerMixin(SyncedMixin(LitElement)) {
	static {
		this.NAME = "lyrics-container";
	}
	render() {
		return html`<slot></slot>`;
	}
};
LyricsContainer = __decorate([customElement(LyricsContainer.NAME)], LyricsContainer);
export { LyricsContainer };
let LyricsWrapper = class LyricsWrapper extends LitElement {
	static {
		LyricsWrapper_1 = this;
	}
	static {
		this.NAME = "lyrics-wrapper";
	}
	static {
...
__decorate([property({ attribute: false })], LyricsWrapper.prototype, "song", void 0);
__decorate([provide({ context: loadedLyricsTypeCtx }), state()], LyricsWrapper.prototype, "loadedLyricsType", void 0);
__decorate([query(LyricsContainer.NAME)], LyricsWrapper.prototype, "container", void 0);
__decorate([provide({ context: scrollTimeoutCtx })], LyricsWrapper.prototype, "scrollTimeout", void 0);
__decorate([provide({ context: scrollContainerCtx })], LyricsWrapper.prototype, "scrollContainer", void 0);
LyricsWrapper = LyricsWrapper_1 = __decorate([customElement(LyricsWrapper.NAME)], LyricsWrapper);
