...
export const SyncedMixin = superClass => {
	...
	__decorate([property()], mixedClass.prototype, "content", void 0);
	__decorate([property({ type: Number })], mixedClass.prototype, "tsp", void 0);
	__decorate([property({ type: Number })], mixedClass.prototype, "tep", void 0);
	return mixedClass;
};
...
export const ScrolledMixin = superClass => {
	...
	__decorate([consume({ context: scrollTimeoutCtx, subscribe: true })], mixedClass.prototype, "scrollTimeout", void 0);
	__decorate([consume({ context: scrollContainerCtx })], mixedClass.prototype, "scrollContainer", void 0);
	return mixedClass;
};
export const SyncedContainerMixin = superClass => {
	...
	__decorate([queryAssignedElements()], mixedClass.prototype, "childs", void 0);
	return mixedClass;
};
